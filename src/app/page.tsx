      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: '20px' }}>
        <div>
          <iframe 
            ...
            frameBorder="no" 
            allow="autoplay" 
            src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1838540424%3Fsecret_token%3Ds-sVFGaAQUncq&color=%23ff5500&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=true">
          </iframe>
          <div 
            style={{
              fontSize: "10px", 
        ...
        <p className="text-xl text-semibold text-center"> Run With Me, out 26th July 2024</p>
        ...
        <p className="text-2xl text-bold text-center"> Send me a screenshot of a completed presave and be entered into a draw to win a free t-shirt! </p>
        <p className="text-l font-semibold text-center"> <Link href={"http://twitter.com/share?text= 🟩🟩  🟩🟩🟩🟩  🟩🟩. %0A I guessed the Ravle correctly! Can you guess what the words are? &url=http://www.ravi.am%0A&hashtags=RAVLE,wordle,unsignedartist,26thJuly2024"} target="_blank" className="text-red-700 underline hover:text-red-300"> Enjoyed playing Ravle? Share it with a friend!</Link></p>
