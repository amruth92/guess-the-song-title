  ...
  return (
    <main className="">
      ...
      {currentWord > 2 && <div className="my-10">
        ...
        <p className="text-2xl text-bold text-center"> <iframe width="100%" height="166" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1838540424%3Fsecret_token%3Ds-sVFGaAQUncq&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/ravimusicuk" title="Ravi Amruth" target="_blank" style="color: #cccccc; text-decoration: none;">Ravi Amruth</a> · <a href="https://soundcloud.com/ravimusicuk/run-with-me-snippet/s-sVFGaAQUncq" title="Run With Me (Snippet)" target="_blank" style="color: #cccccc; text-decoration: none;">Run With Me (Snippet)</a></div></p>
