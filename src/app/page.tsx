  ...
  return (
    <main className="">
      ...
      {currentWord > 2 && <div className="my-10">
        ...
        <p className="text-xl text-bold text-center"> <Link href={"https://idm.fm/run-with-me/presavecallback?context=pre_save&service=spotify&redirecturl&actionid&order=665cecaa51c0c8474a4e069c&user=raviamruth&status=success&origin=presavecallback"} target="_blank" className="text-blue-500 underline hover:text-blue-600"> Pre-save Run With Me NOW</Link>!</p>
        <p className="text-l text-semibold text-center"> <Link href={"http://twitter.com/share?text= 🟩🟩  🟩🟩🟩🟩  🟩🟩. %0A I guessed the Ravle correctly! Can you guess what the words are? &url=http://www.ravi.am%0A&hashtags=RAVLE,wordle,unsignedartist,19thJuly2024"} target="_blank" className="text-blue-500 underline hover:text-blue-600"> Enjoyed playing Ravle? Share it with a friend!</Link>!</p>
      </div>}
